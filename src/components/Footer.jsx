...
export default function FooterCom() {
  return (
    <Footer container className="border border-t-4 border-cyan-500">
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          ...
          <div className="grid grid-cols-2 gap-8  mt-6 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link
                  href="https://github.com/abdulhasibn"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Github
        ...
        <div className=" w-full  sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex gap-8 mt-5 sm:mt-0">
            ...
            <Footer.Icon
              href="https://twitter.com/abdulhasibn99"
              icon={BsTwitter}
            />
            <Footer.Icon
              href="https://github.com/abdulhasibn"
